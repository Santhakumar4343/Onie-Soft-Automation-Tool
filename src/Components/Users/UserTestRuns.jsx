...
const UserTestRuns = () => {
  ...
  const fetchTestRuns = () => {
    getTestRunByProjectId(project.id, "", page - 1, itemsPerPage)
      .then((response) => {
        setTestRuns(response.data.content);
        setTotalPages(response.data.totalPages);
      })
  ...
  return (
    <div className="container ">
      <div className="d-flex align-items-center justify-content-between">
        ...
        <h4
          ...
          style={{ color: "#4f0e83", marginRight: "70px" }}
        >
    ...
    `}
                  ...
                  <td>
                    <Tooltip title="Duplicate" arrow>
                      <ContentCopyIcon
                        ...
                        onClick={() =>
                          testRun.testCaseCount !== 0 &&
                          handleCloneTestcases(testRun)
                        }
                      />
                    </Tooltip>
                  </td>
                  <td>
                    <Tooltip title="Execute / schedule" arrow>
                      <PlayArrow
                        style={{
                          cursor:
                            testRun.testCaseCount === 0
      ...
      <Modal
        open={testRunCloneModal}
        onClose={() => setTestRunCloneModal(false)}
      >
        <div
          style={{
            display: "flex",
        ...
        >
          ...
          >
            ...
            <form className="mt-4" onSubmit={handleCloneFormSubmit}>
              <div className="form-group">
                <input
                  type="text"
                  name="testRunName"
              ...
              <div className="text-center">
                ...
                <button
                  ...
                  disabled={isLoading}
                >
                  {isLoading ? "Cloning..." : "Clone Test Run"}
                </button>
              </div>
            </form>
          </div>
