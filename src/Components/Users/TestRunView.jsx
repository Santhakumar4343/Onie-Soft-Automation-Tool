...
function UserTestRunView() {
  ...
  const handleNestedChange = (setter) => (key) => (valueOrEvent) => {
    const newValue =
  ...
  const handlescheduledDateChange = (newValue) => {
    // Convert Dayjs object to LocalDate (in ISO format)
    const formattedDate = newValue
      ? newValue.toISOString().split("T")[0]
      : null;
    handleNestedChange(setScheduleConfig)("scheduledDate")(formattedDate);
  };
  ...
  const handlescheduledTimeChange = (newValue) => {
    ...
    handleNestedChange(setScheduleConfig)("scheduledTime")(formattedTime);
  };
              ...
              <Grid container spacing={2}>
                  ...
                  <DatePicker
                    ...
                    value={
                      scheduleConfig.scheduledDate
                        ? dayjs(scheduleConfig.scheduledDate)
                        : null
                    }
                ...
                <Grid item xs={6}>
                  <TimePicker
                    label="Schedule Time"
                    value={
                      scheduleConfig.scheduledTime
                        ? dayjs(scheduleConfig.scheduledTime, "HH:mm") // Convert string to dayjs
                        : null
                    }
